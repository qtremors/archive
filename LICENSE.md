...
- Include a link to the original repository: `https://github.com/qtremors/archive`
...
```
Based on Archive by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/archive
```
