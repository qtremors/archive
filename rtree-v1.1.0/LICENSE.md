...
- Include a link to the original repository: `https://github.com/qtremors/rtree`
...
```
Based on rtree by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/rtree
```
